...
import cs3500.Image;
import cs3500.controller.CommandMakeInvisible;
...
/**
 * Tests for the CommandMakeInvisible command class.
 */
public class CommandMakeInvisibleTest {
  ...
  public void testCommandMakeInvisibleNullLayerNumber() {
    this.c = new CommandMakeInvisible(null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testOperateMakeInvisibleNullModel() {
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image2x2);
    this.c = new CommandMakeInvisible("1");
    this.c.operate(null);
  }

  @Test
  public void testOperateMakeInvisibleFirstLayer() {
    this.model.addEmptyLayer();
  ...
  @Test
  public void testOperateMakeInvisibleSecondLayer() {
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image2x2);
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image2x2);
    this.model.addEmptyLayer();
    this.c = new CommandMakeInvisible("2");
    this.c.operate(model);
    assertFalse(this.model.getLayers().get(1).getVisibility());
  }

  @Test
  public void testOperateMakeInvisibleInvisibleLayer() {
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image3x3);
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image3x3);
    this.model.addEmptyLayer();
    this.c = new CommandMakeInvisible("3");
    this.c.operate(model);
    assertFalse(this.model.getLayers().get(2).getVisibility());
  }

  @Test(expected = IllegalArgumentException.class)
  public void testOperateMakeInvisibleNonExistingLargeLayer() {
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image3x3);
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image3x3);
    this.model.addEmptyLayer();
    this.c = new CommandMakeInvisible("5");
    this.c.operate(model);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testOperateMakeInvisibleNonExistingSmallLayer() {
    this.model.addEmptyLayer();
    this.model.loadNewImage(this.image3x3);
    this.model.addEmptyLayer();
    this.c = new CommandMakeInvisible("-1");
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testOperateMakeInvisibleNoLayers() {
    this.c = new CommandMakeInvisible("1");
    this.c.operate(model);
  }
}